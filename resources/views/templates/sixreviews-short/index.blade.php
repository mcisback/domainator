            ...
            <div class="container">
                <div class="text-content">
                    ...
                    <p>{{$tr('We dont sell the services advertised in this ad. We are an introductionary service that
                        helps users decide what they want to learn more about. All the companies mentioned are licenced
                        in their own respected countries.')}}</p>
                </div>
            </div>
        </div>
    </div>
